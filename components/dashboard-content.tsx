  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        {/* Purple gradient orb with enhanced styling */}
        <div className="relative w-32 h-32 mb-8">
          <div className="w-32 h-32 bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 rounded-full shadow-2xl shadow-purple-400/30 animate-pulse"></div>
          <div className="absolute inset-4 bg-gradient-to-br from-purple-300 to-purple-500 rounded-full opacity-50"></div>
          <div className="absolute inset-8 bg-white/20 rounded-full backdrop-blur-sm flex items-center justify-center">
        ...
        <div className="text-center mb-12 max-w-md">
          ...
          <p className="text-gray-600">Choose a scenario to start practicing your sales skills with our AI-powered trainer.</p>
        </div>
