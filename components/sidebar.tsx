    ...
    <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="font-semibold text-gray-900">Professional Sales Training</h1>
        </div>
        <div className="flex items-center justify-between">
          <p className="text-sm text-gray-600">{profile?.email || user.email}</p>
          <ConfirmDialog
            title="Sign Out"
            description="Are you sure you want to sign out? Any active training sessions will be terminated."
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400">
                        {isClient ? format(new Date(conversation.created_at), 'MMM dd, yyyy • HH:mm') : 'Loading...'}
                      </p>
                    </div>
                  </div>
                </div>
